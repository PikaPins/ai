...
### [8] [Echelon: Auditable Aggregate-Only Language-Model Adaptation Across Privacy Boundaries](https://arxiv.org/abs/2606.02958)
...
### [9] [Patcher: Post-Hoc Patching of Backdoored Large Language Models](https://arxiv.org/abs/2606.02995)
...
### [10] [SkillGuard: A Permission Framework for Agent Skills](https://arxiv.org/abs/2606.03024)
...
### [14] [Private Embedding Lookup with Encrypted Compact Queries under Fully Homomorphic Encryption](https://arxiv.org/abs/2606.03191)
...
### [15] [Generative AI-Enabled Refund Fraud in Chinese E-Commerce: Investigation on Merchants and Platform Workers](https://arxiv.org/abs/2606.03215)
...
### [16] [The Role of Domain-Specific Features in Malware Detection: A macOS Case Study](https://arxiv.org/abs/2606.03218)
...
### [17] [The Security Budget of Code LLMs: An Information-Theoretic Capacity-Security Bound](https://arxiv.org/abs/2606.03308)
*Jianwei Tai*
...
### [18] [AI Model Extraction Attacks: Bypassing Single-Client Assumptions in Defenses](https://arxiv.org/abs/2606.03381)
...
### [19] [Operationalizing Cyber Attack Prediction: A Gap-Prioritized Framework with Dataset and Model Selection Guidelines](https://arxiv.org/abs/2606.03386)
...
### [20] [Bastet: A Fine-Grained Expert-Labeled Dataset for DeFi Smart Contract Vulnerability Detection](https://arxiv.org/abs/2606.03387)
...
### [21] [FlowGuard: Flow Matching for Identity-Independent Detection of Data-Free Model Stealing Attacks on Energy System Intrusion Detection Systems](https://arxiv.org/abs/2606.03430)
...
### [23] [FORGE: Multi-Agent Graduated Exploitation and Detection Engineering](https://arxiv.org/abs/2606.03453)
*Farooq Shaikh*
...
### [24] [NeuroArmor: Safe-Variant-Guided Representation Consistency for Selective Re-Anchoring in Jailbreak Defense](https://arxiv.org/abs/2606.03486)
...
### [25] [Privacy-Preserving High-Resolution Image Gradient Computation Based on Fully Homomorphic Encryption](https://arxiv.org/abs/2606.03513)
*Yufei Zhou*
...
### [26] [High-Precision APT Malware Attribution with Out-of-Scope Resilience](https://arxiv.org/abs/2606.03523)
...
### [27] [Towards Intrusion Detection Systems for RPL-based IoT Networks using Foundation Models](https://arxiv.org/abs/2606.03530)
...
### [28] [Channel Chart Location Privacy Based on Geo-Indistinguishability](https://arxiv.org/abs/2606.03571)
...
### [29] [Testing LLM Arithmetic Reasoning Generalization with Automatic Numeric-Remapping Attacks](https://arxiv.org/abs/2606.03606)
...
### [30] [Q-FE: A Quantum-Native 6G Far-Edge Architecture Securing Industrial IoT Digital Twins via CSIDH-PQC and Asynchronous Federated Learning](https://arxiv.org/abs/2606.03611)
*Vincenzo Sammartino*
...
### [31] [Black-box, Adaptive, Efficient, Transferable, Harmful, Applicable... Attacks Are All You Need to Break LLMs](https://arxiv.org/abs/2606.03647)
...
### [32] [Don't Trust Us: A privacy-by-design android malware detection pipeline](https://arxiv.org/abs/2606.03714)
...
### [33] [Collision Resistance of Single-Layer Neural Nets](https://arxiv.org/abs/2606.03807)
