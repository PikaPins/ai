...
### [1] [Peak + Accumulation: A Proxy-Level Scoring Formula for Multi-Turn LLM Attack Detection](https://arxiv.org/abs/2602.11247)
*J Alex Corll*

Main category: cs.CR

TL;DR: 本文提出了一种新的评分公式，用于检测多轮对话中的恶意意图，该公式结合了单轮风险高峰、持续比率和类别多样性。实验结果显示，该公式在召回率为90.8%的情况下，保持了1.20%的低误报率和85.9%的F1分数。


<details>
  <summary>Details</summary>
Motivation: 现有的单一轮次检测方法无法有效处理分布于多轮次的攻击意图，因此本文旨在提供一种新的评分方法，以提升对多轮对话攻击的检测能力。

Method: 本文的方法包括以下步骤：识别传统的加权平均方法的缺点，并在此基础上提出了峰值+累积评分公式；采用与变化点检测（CUSUM）、贝叶斯信念更新和安全风险警报方法的类比；通过大量的实验验证新方法的有效性。

Result: 实验表明，提出的评分公式在召回率为90.8%的情况下，保持了1.20%的低误报率和85.9%的F1分数。此外，通过参数分析发现，当持续参数接近0.4时，召回率提高了12个百分点，几乎未增加误报率。

Conclusion: 本文提出了一种有效的多轮对话攻击检测方法，并通过实验证明了其在降低误报率和提高召回率方面的优势，为抵抗多轮注入式攻击提供了新的思路。
...
### [2] [Modelling Trust and Trusted Systems: A Category Theoretic Approach](https://arxiv.org/abs/2602.11376)
*Ian Oliver,Pekka Kuure*

Main category: cs.CR

TL;DR: 该论文提出了一种基于范畴论的信任建模框架，特别是应用于可信计算系统和远程认证。通过将信任元素、声明、结果和决策形式化为范畴中的对象，并将认证、验证和决策过程表示为范畴中的同态，论文提供了一种严谨的理解信任建立的方法，并定义了诸如‘值得信任’和‘阐述’之类的术语。利用Heyting代数形式化信任决策空间，以实现二元信赖性之外的细致化信任等级。通过范畴论中的乘方定义认证操作的组合，提供了评估认证环境表示能力的基础。通过具体示例解释了这一模型，并讨论了用于建模动态及多种组合系统的挑战。


<details>
  <summary>Details</summary>
Motivation: 在可信计算系统和远程认证中，信任的定义和理解具有挑战性。范畴论提供了一种更严谨的方法来处理这些挑战。

Method: 论文通过引入范畴论的概念来定义信任元素和认证过程，从而提供了一个形式化的信任模型。使用Heyting代数来扩展信任等级并定义信任决策空间。通过范畴理论中的乘方来定义认证操作的组合。

Result: 论文提出了一种基于范畴论的信任建模框架，成功地将信任元素和认证过程形式化，并通过Heyting代数和范畴论中的乘方扩展了信任等级的定义。通过使用具体示例展示了模型的有效性。

Conclusion: 该论文的结果表明，基于范畴论的框架可以有效地管理和理解信任，特别是在复杂的远程认证环境中。这一框架为进一步研究信任和认证的更深层次问题提供了坚实的基础。
...
### [3] [Multi Layer Protection Against Low Rate DDoS Attacks in Containerized Systems](https://arxiv.org/abs/2602.11407)
*Ahmad Fareed,Bilal Al Habib,Anne Pepita Francis*

Main category: cs.CR

TL;DR: 本文提出了一种多层次的DDoS防护系统，旨在保护容器化云基础设施免受低速率DDoS攻击。该系统整合了Web应用防火墙、速率限制、动态黑名单机制、TCP和UDP头部分析，并应用零信任原则，在攻击生命周期的不同阶段检测并阻止恶意流量，增强了系统的安全性与弹性。


<details>
  <summary>Details</summary>
Motivation: 由于低速率DDoS攻击具有低流量特征，容易被忽视，但对互联网应用程序造成严重威胁，因此需要一种有效的防护机制。

Method: 该系统采用了多层次防御策略，综合运用了Web应用防火墙、速率限制、动态黑名单、TCP和UDP头部分析，并实施了零信任原则。

Result: 实验结果表明，该系统能够有效检测并阻止低速率DDoS攻击，显著提高了容器化环境下的安全性和弹性。

Conclusion: 基于零信任原则的多层次DDoS防护系统能够在容器化环境中有效抵御低速率攻击，具有较高实用性和推广价值。
...
### [4] [Security Assessment of Intel TDX with support for Live Migration](https://arxiv.org/abs/2602.11434)
*Kirk Swidowski,Daniel Moghimi,Josh Eads,Erdem Aktas,Jia Ma*

Main category: cs.CR

TL;DR: Google与Intel在2025年第二和第三季度合作对Intel TDX进行了安全评估，发现了六个与安全相关的发现，强调了迭代改进和综合安全控制对于增强保密计算的重要性。


<details>
  <summary>Details</summary>
Motivation: 进行此评估是为了发现潜在的安全问题，确保Intel TDX的最新版本在支持Live Migration和TD Partitioning时保持安全。

Method: Google使用了一台支持TDX的计算节点来开发测试工具和PoC，并利用Gemini和NotebookLM来分析复杂的规范。

Result: 发现了一个能够使VMM完全操控TD的漏洞，以及四个能让恶意VMM或TD泄露Intel TDX模块机密内存的漏洞。还发现了一些虽有安全影响但未分类为漏洞的弱点或错误。

Conclusion: 安全评估显示需要持续改进并采取综合的安全控制措施来增强保密计算的安全性。
...
### [5] [Hardening the OSv Unikernel with Efficient Address Randomization: Design and Performance Evaluation](https://arxiv.org/abs/2602.11445)
*Alex Wollman,John Hastings*

Main category: cs.CR

TL;DR: 通过在OSv中引入类似于ASLR的多样性，随机化应用程序基础和线程栈区域的地址，提高了OSvunikernel对可靠利用的抵抗力。


<details>
  <summary>Details</summary>
Motivation: 当前unikernels如OSv缺乏ASLR这样的安全措施，这使得它们更容易受到利用。因此，研究旨在通过引入ASLR技术来增强unikernels的防护能力。

Method: 在核心内存管理和加载程序的机制中进行有针对性的修改，以随机化应用程序基础地址和线程栈区域。评估了修改后的OSv在启动时间、应用运行时间和内存使用方面的表现。

Result: 修改后的OSv保持了原有的轻量级设计目标，且在与未修改的基础版本进行对比时，展示了相似的启动时间、应用程序运行时间和内存使用情况。此外，生成的地址表现出均匀分布的特性。

Conclusion: 研究显示，布局随机化防御机制能够高效且有效地集成到OSvunikernels中，提升了其抵抗可靠的利用能力。
...
### [6] [Cachemir: Fully Homomorphic Encrypted Inference of Generative Large Language Model with KV Cache](https://arxiv.org/abs/2602.11470)
*Ye Yu,Yifan Zhou,Yi Chen,Pedro Soto,Wenjie Xiong,Meng Li*

Main category: cs.CR

TL;DR: Cachemir 提出了一种新型的基于完全同态加密（FHE）加密的生成式大型语言模型（LLM）推理框架，通过设计新的 HE 压缩算法、优化的向量-矩阵乘法计算方法以及增强的密文重新打包策略，解决了现有基于 FHE 的推理框架无法有效利用 key-value 缓存的问题。


<details>
  <summary>Details</summary>
Motivation: 鉴于生成式 LLM 在多领域的广泛应用，它们的部署引发了关于用户数据隐私的重要讨论。现有的基于完全同态加密的推理框架虽然在隐私保护方面表现出色，但在利用 key-value 缓存优化推理过程方面存在明显不足，导致推理延迟过高。

Method: Cachemir 通过引入一组新颖的 HE 压缩算法和改进的向量-矩阵乘法计算方法来优化基于 FHE 的 LLM 推理，同时提出了密文重新打包策略来减少重新打包成本。

Result: 使用 Cachemir 方法，在基于 CPU 的情况下，Cachemir 达到了 MOAI 和 THOR 方法的 48.83 倍和 67.16 倍的速度提升，并且在 GPU 上生成一个输出标记只需不到 100 秒。

Conclusion: Cachemir 框架证明了在保护用户隐私的前提下，通过优化的算法设计可以显著提高 LLM 的推理效率。
...
### [7] [Future Mining: Learning for Safety and Security](https://arxiv.org/abs/2602.11472)
...
### [8] [Jailbreaking Leaves a Trace: Understanding and Detecting Jailbreak Attacks from Internal Representations of Large Language Models](https://arxiv.org/abs/2602.11495)
...
### [9] [Differentially Private and Communication Efficient Large Language Model Split Inference via Stochastic Quantization and Soft Prompt](https://arxiv.org/abs/2602.11513)
...
### [10] [Stop Tracking Me! Proactive Defense Against Attribute Inference Attack in LLMs](https://arxiv.org/abs/2602.11528)
...
### [11] [QDBFT: A Dynamic Consensus Algorithm for Quantum-Secured Blockchain](https://arxiv.org/abs/2602.11606)
...
### [12] [DMind-3: A Sovereign Edge--Local--Cloud AI System with Controlled Deliberation and Correction-Based Tuning for Safe, Low-Latency Transaction Execution](https://arxiv.org/abs/2602.11651)
...
### [13] [LoRA-based Parameter-Efficient LLMs for Continuous Learning in Edge-based Malware Detection](https://arxiv.org/abs/2602.11655)
...
### [14] [Reliable and Private Anonymous Routing for Satellite Constellations](https://arxiv.org/abs/2602.11764)
...
### [15] [More Haste, Less Speed: Weaker Single-Layer Watermark Improves Distortion-Free Watermark Ensembles](https://arxiv.org/abs/2602.11793)
...
### [16] [Solving the Post-Quantum Control Plane Bottleneck: Energy-Aware Cryptographic Scheduling in Open RAN](https://arxiv.org/abs/2602.11820)
...
### [17] [Resource-Aware Deployment Optimization for Collaborative Intrusion Detection in Layered Networks](https://arxiv.org/abs/2602.11851)
...
### [18] [Agentic AI for Cybersecurity: A Meta-Cognitive Architecture for Governable Autonomy](https://arxiv.org/abs/2602.11897)
...
### [19] [PAC to the Future: Zero-Knowledge Proofs of PAC Private Systems](https://arxiv.org/abs/2602.11954)
...
### [20] [Evaluation of Security-Induced Latency on 5G RAN Interfaces and User Plane Communication](https://arxiv.org/abs/2602.12059)
...
### [21] [MedExChain: Enabling Secure and Efffcient PHR Sharing Across Heterogeneous Blockchains](https://arxiv.org/abs/2602.12106)
...
### [22] [BlackCATT: Black-box Collusion Aware Traitor Tracing in Federated Learning](https://arxiv.org/abs/2602.12138)
...
### [23] [Unknown Attack Detection in IoT Networks using Large Language Models: A Robust, Data-efficient Approach](https://arxiv.org/abs/2602.12183)
...
### [24] [MalTool: Malicious Tool Attacks on LLM Agents](https://arxiv.org/abs/2602.12194)
...
### [25] [Keeping a Secret Requires a Good Memory: Space Lower-Bounds for Private Algorithms](https://arxiv.org/abs/2602.12209)
...
### [26] [Legitimate Overrides in Decentralized Protocols](https://arxiv.org/abs/2602.12260)
*Oghenekaro Elem,Nimrod Talmon*

Main category: cs.CR

TL;DR: 该研究提出了一个包含干预范围和触发权限两个维度的紧急架构分类税则，通过实证分析提出了三点预测，为应急治理提供了定量工程设计原则。


<details>
  <summary>Details</summary>
Motivation: 当前去中心化协议中的应急机制设计存在高技术损失和高主观性问题，研究旨在通过定量工程解决这一问题。

Method: 研究定义了一个范围×权限的分类税则，构建了一个随机成本最小化问题，并通过705起已记录的漏洞事件实证验证了设计。

Result: 研究结果表明，不同的触发权限类型会影响遏制时间，鲁棒性损失呈现出厚尾分布，社区情绪会显著影响应急治理的实际成本。

Conclusion: 研究提供了可测试的设计原则，推动应急治理从主观辩论转向定量工程。
...
### [27] [Explaining AI Without Code: A User Study on Explainable AI](https://arxiv.org/abs/2602.11159)
*Natalia Abarca,Andrés Carvallo,Claudia López Moncada,Felipe Bravo-Marquez*

Main category: cs.AI

TL;DR: 该研究在无代码ML平台DashAI中集成了一种以用户为中心的可解释AI模块，结合了PDP、PFI和KernelSHAP三种技术，评估了其在初学者和专家中的使用情况和解释效果，结果表明，无论是初学者还是专家，都能通过解释提高对预测的信任度。


<details>
  <summary>Details</summary>
Motivation: 随着机器学习在敏感领域的应用增加，透明性成为关键问题。针对这一点，研究团队开发了一个以用户为中心的可解释AI模块，旨在让无代码ML平台DashAI的用户更容易理解和信任模型的预测。

Method: 研究团队在DashAI中引入了一个结合了PDP、PFI和KernelSHAP技术的人性化XAI模块，进行了详细地数据处理和模型训练，并通过用户研究来评估其解释的有效性和用户满意度。

Result: 用户研究显示，无论初学者还是专家，在使用该XAI模块进行解释后，其预测信任度得到了提升。初学者对解释的满意度较高，而专家则更加关注解释的充分性和完整性。

Conclusion: 这项研究发现，可解释AI在无代码ML平台中的应用不仅是向初级用户开放的一个重要机会，同时也需提供充分且详细的信息，以满足专家的需求。
...
TL;DR: 该论文提出了决策值映射的概念，并介绍了DecisionDB基础设施，该基础设施使用从内容和一次写入存储的文件生成的标识符记录、重播和审计这些关系。决策值映射将表示空间划分为持久性区域和边界。


<details>
  <summary>Details</summary>
Motivation: 为了阐明不同数据表示在相同计算引擎中应用时结果的一致性和可预测性问题。

Method: 通过形式化决策值映射和开发DecisionDB基础设施来实现。

Result: 实现了决策值映射的概念验证，并提供了一种机制来记录、重播和审计表示之间的结果关系。

Conclusion: 论文确定了表示空间的持久性区域和边界，将决策重用视为可机械验证的条件。
...
### [30] [Dissecting Subjectivity and the "Ground Truth" Illusion in Data Annotation](https://arxiv.org/abs/2602.11318)
*Sheza Munir,Benjamin Mah,Krisha Kalsi,Shivani Kapania,Julian Posada,Edith Law,Ding Wang,Syed Ishtiaque Ahmed*

Main category: cs.AI

TL;DR: 这篇文章分析了机器学习中‘黄金标准’假设对数据注释实践的影响，发现现有的注释机制存在系统性偏差，地理霸权和模型中介注释加剧了这一问题。研究提出了一些建议，旨在重新认识到分歧的价值，并构建包含多元视角的注释基础设施。


<details>
  <summary>Details</summary>
Motivation: 由于‘黄金标准’假设忽略了人为分歧的重要性，本文通过回顾分析，揭示了数据注释过程中的系统性问题，尤其是当前架构中人类作为验证者的角色增加了偏差，呼吁重新认识分歧的作用。

Method: 作者进行了一项系统文献回顾，筛选了2020-2025年间在ACM和IEEE等顶级会议发表的30,897篇记录中的相关论文，总共最终分析了346篇。通过反思性主题分析，作者发现了一些关键问题，并提出了改进建议。

Result: 研究揭示了注释过程中存在的系统性问题，包括存储偏差、地理霸权新兴的技术现实、以及人类作为验证者在数据处理中的角色。作者还讨论了在文化多元性的背景下，统计模型的误诊现象（‘嘈杂传感器’谬误），并提出建议来构建更包容的注释基础设施。

Conclusion: 为了应对这些系统性紧张局势，本文建议构建多元注释基础设施，从寻找单一‘正确答案’转变为描绘人类经验的多样性，强调高保真的分歧信号对于构建文化敏感模型的重要性。
...
### [31] [Bi-Level Prompt Optimization for Multimodal LLM-as-a-Judge](https://arxiv.org/abs/2602.11340)
*Bo Pan,Xuan Kan,Kaitai Zhang,Yan Yan,Shunwen Tan,Zihao He,Zixin Ding,Junjie Wu,Liang Zhao*

Main category: cs.AI

TL;DR: 本文提出了一种双层提示优化框架（BLPO），该框架将图像转换为文本表示，同时保留了评估相关的视觉线索，以解决多模态模型在处理图像时由于上下文窗口限制导致的有效提示优化难以实现的问题。实验表明该方法的有效性。


<details>
  <summary>Details</summary>
Motivation: 近年来，大语言模型（LLMs）已经成为评估AI生成内容的自动化裁判。尽管取得了成功，但LLM的评估结果与人类判断的对齐仍具有挑战性。现有的自动提示优化（APO）方法主要针对文本评估，对多模态设置下的图像评估关注不足。本文旨在解决这一问题。

Method: 本文提出了一种双层提示优化框架（BLPO），通过将图像转换为文本表示来增强多模态模型的提示优化能力，同时在有限的上下文预算下保持评估的相关性。方法包括两个层面的优化：一是对多模态LLM本身进行提示优化，二是对图像到文本（I2T）的提示进行优化。

Result: 本文提出的BLPO方法在四个数据集和三种LLM裁判上的实验结果表明，相比于现有的自动提示优化方法，BLPO在保持评估相关性的同时，能够更有效地进行提示优化。

Conclusion: 本文提出了一种创新的双层提示优化框架，有效解决了在多模态设置下自然语言模型评估图像的难题。该方法的实验验证了其在提升评估质量方面的优势，为未来的研究提供了新的方向。
...
### [32] [ReplicatorBench: Benchmarking LLM Agents for Replicability in Social and Behavioral Sciences](https://arxiv.org/abs/2602.11354)
...
### [33] [Causal-JEPA: Learning World Models through Object-Level Latent Interventions](https://arxiv.org/abs/2602.11389)
...
### [34] [GHOST: Unmasking Phantom States in Mamba2 via Grouped Hidden-state Output-aware Selection & Truncation](https://arxiv.org/abs/2602.11408)
...
### [35] [TRACER: Trajectory Risk Aggregation for Critical Episodes in Agentic Reasoning](https://arxiv.org/abs/2602.11409)
...
### [36] [Distributionally Robust Cooperative Multi-Agent Reinforcement Learning via Robust Value Factorization](https://arxiv.org/abs/2602.11437)
...
### [37] [Credit Where It is Due: Cross-Modality Connectivity Drives Precise Reinforcement Learning for MLLM Reasoning](https://arxiv.org/abs/2602.11455)
...
### [38] [AgentLeak: A Full-Stack Benchmark for Privacy Leakage in Multi-Agent LLM Systems](https://arxiv.org/abs/2602.11510)
...
### [39] [Human-Inspired Continuous Learning of Internal Reasoning Processes: Learning How to Think for Adaptive AI Systems](https://arxiv.org/abs/2602.11516)
*Hong Su*
...
### [40] [CausalAgent: A Conversational Multi-Agent System for End-to-End Causal Inference](https://arxiv.org/abs/2602.11527)
...
### [41] [Budget-Constrained Agentic Large Language Models: Intention-Based Planning for Costly Tool Use](https://arxiv.org/abs/2602.11541)
...
### [42] [SemaPop: Semantic-Persona Conditioned Population Synthesis](https://arxiv.org/abs/2602.11569)
...
### [43] [Learning to Configure Agentic AI Systems](https://arxiv.org/abs/2602.11574)
...
### [46] [scPilot: Large Language Model Reasoning Toward Automated Single-Cell Analysis and Discovery](https://arxiv.org/abs/2602.11609)
...
### [47] [When Agents Disagree With Themselves: Measuring Behavioral Consistency in LLM-Based Agents](https://arxiv.org/abs/2602.11619)
*Aman Mehta*
...
### [48] [Neuro-Symbolic Multitasking: A Unified Framework for Discovering Generalizable Solutions to PDE Families](https://arxiv.org/abs/2602.11630)
...
TL;DR: 本文提出了一个稳健的医疗对齐范式，通过构建一个全面的多维医疗对齐矩阵，解决了多目标异质奖励信号下的梯度主导和优化不稳定问题，引入了统一的优化机制，实现了对齐目标的有效优化。


<details>
  <summary>Details</summary>
Motivation: 目前在大规模语言模型对齐中取得的强化学习进展，难以有效应用于高风险的医疗问答场景。原有的RLHF和RLVR方法无法高效地确保医疗知识的绝对正确性，也无法有效处理复杂的临床环境。此外，医疗对齐需要同时优化正确性、安全性与合规性，而多目标不一致的奖励信号可能造成优化冲突。

Method: 论文首先构建了一个全面的多维医疗对齐矩阵，将对齐目标分解为四大类：基线能力、专家知识、在线反馈和格式规范。每个类别中建立了一个观察度量反馈致归因诊断，进而驱动可优化奖励的闭环，提供细粒度、高分辨率的监督信号。此外，论文引入了统一的优化机制，采用Reference-Frozen Normalization进行奖励尺度对齐，并通过Tri-Factor Adaptive Dynamic Weighting策略来协作优化，以实现弱项导向、风险优先以及冗余去除的目标。

Result: 通过实验结果证明了本文所提范式的有效性，能够有效应用于医疗场景的现实评估，为垂直领域的复杂对齐建立了新的范式。

Conclusion: 总之，本文提出了一项完善的医疗对齐方案，以解决现有方法在医疗应用场景中的局限性，为医疗领域对齐方法的发展提供了新思路。
...
TL;DR: 该研究提出了一种名为BHI的数据驱动框架，用于评估大型语言模型基准测试的健康状况，涵盖了能力鉴别、反饱和以及影响力等三个维度，旨在提供宏观层面的基准测试健康度量化评估，支持基准测试的选择并促进下一代评估协议的动态生命周期管理。


<details>
  <summary>Details</summary>
Motivation: 当前基准测试的可靠性降低，存在评分膨胀和选择性报告的问题，使得社区对哪些评估结果仍可信赖存在不确定性。研究者希望提供一种新的评估框架来解决这一问题。

Method: 研究者通过系统地筛选和验证技术报告中的106个基准测试，提出了BHI框架，从三个方面评估基准测试的健康状况。

Result: BHI框架成功地从106个基准测试中量化了评估健康状况的三大维度，提供了宏观层面上的基准测试健康度评估，有助于选择基准测试并指导下一步的工作。

Conclusion: 该研究提出的BHI框架为指导大型语言模型基准测试的选择和管理提供了有价值的工具，为下一代评估协议的制定奠定了基础。
...
TL;DR: 论文探讨了机器学习模型因捷径导致的缺陷，提出了Epistemic Regret Minimization (ERM) 方法，旨在独立于任务成功惩罚因果推理错误，并通过三层次架构结合物理基座定理和因果推理校正操作支柱，证明了从有限样本中恢复真实干预分布，并通过实验验证了该方法的有效性。


<details>
  <summary>Details</summary>
Motivation: 为了克服机器学习模型因学习到的捷径而导致的在不同分布情境下表现出色但缺乏因果推理能力的问题，论文提出了一种新的学习方法，以确保模型能够进行正确的因果推理。

Method: 论文采用Epistemic Regret Minimization (ERM) 方法，将其嵌入三层次架构，并通过证明和实验验证了该方法的有效性。同时，提出了一种物理基座定理，证明并结合了操作语言和do-因果因果计算，并通过AGM后提出条件下的因果推理校正操作，防止因捷径导致的扎根，引入了一种故障模式分类系统以应对各种推理错误。

Result: 论文证明了通过有限样本可以从真实干预分布中恢复，对于1,360个因果陷阱场景和六个前沿大模型的实验表明，尽管先进模型表现出更强的不可泛化纠正，但定向的ERM反馈仍能使陷入错误推理的错误恢复53-59%。

Conclusion: 论文提出了一种新的学习目标——Epistemic Regret Minimization (ERM) 方法，通过三层次架构，结合物理基座定理和因果推理校正操作防止模型因学习到捷径而陷入错误因果推理，同时还提供了如何检测和防止此类错误的方法。
...
TL;DR: 本文提出了一种Vector-to-Graph (V2G) 管道，将CAD图转换为属性图以增强视觉理解，从而解决当前多模态大语言模型在工程规范图中缺乏结构性理解的问题。V2G在电气合规检查基准测试中提高了解错率，展示了结构感知表示在实际部署多模态AI于工程领域中的潜力。


<details>
  <summary>Details</summary>
Motivation: 当前的多模态大语言模型在理解和处理工程图时存在结构性理解能力不足的问题，这限制了其在相关领域的应用。

Method: 提出了一个从矢量到图（V2G）的管道，将CAD图转换为用于编码组件和连接性的属性图。

Result: 在电气合规检查基准测试中，V2G方法在各类错误分类上取得了显著的准确性提升，而现有的多模态大语言模型则接近随机水平。

Conclusion: 研究结果表明结构性表示比基于像素的方法更可靠，为多模态AI在工程领域的实际部署指明了方向。
...
TL;DR: 提出了一种在推理时基于置信度的路由机制ThinkRouter, 它根据置信度决定将推理导向离散token空间或潜在空间，从而提高了准确性并缩短了生成长度。


<details>
  <summary>Details</summary>
Motivation: 现有的潜在推理方法在不同的场景下效果差异较大。由于低置信度的思考路径中包含的低置信度步骤较少且可能会引入并传播噪声，提出了一种新的基于置信度的路由机制来优化推理过程。

Method: 在模型低置信度时，路由推理到离散token空间；在高置信度时，路由到潜在空间。

Result: ThinkRouter在多项STEM推理和编码基准测试中优于显式CoT，随机路由和潜在推理基线，平均提高了19.70的Pass@1，并减少了最多15.55%的生成长度。

Conclusion: ThinkRouter可以校准来自显式CoT和潜在推理的错误，并通过整体降低模型置信度加速结束于思考的token生成。
...
TL;DR: 提出了一种新的模型合并框架SCF-RKL，通过稀疏、分布感知的更新直接在权重空间操作，利用逆Kullback-Leibler散度衡量功能差异并有选择地融合互补参数，从而在保稳定性的基础上提升模型能力。


<details>
  <summary>Details</summary>
Motivation: 现有的模型合并方法主要依赖参数空间的启发式方法，容易导致功能干扰增加，影响模型的泛化能力和生成稳定性。因此，需要一种新的方法来减少这种干扰，同时能够有效增强模型的能力。

Method: SCF-RKL框架通过计算模型之间的逆Kullback-Leibler散度来衡量功能差异，并通过稀疏的、分布感知的更新来选择性地融合互补参数。

Result: 与现有的模型合并方法相比，SCF-RKL在广泛的模型规模和架构下，包括注重推理和指令调整的模型上，显示出了更优的性能，并且保持了良好的泛化能力和生成稳定性。

Conclusion: SCF-RKL框架提供了一种有效的模型合并方法，能够减少功能干扰，保持模型的稳定性和能力。
...
TL;DR: 该工作提出了Text2GQL-Bench，一个统一的Text-to-GQL基准，包含多GQL数据集和评估方法，以全面评估模型性能。


<details>
  <summary>Details</summary>
Motivation: 现有的Text-to-GQL系统缺乏高质量的基准数据集和评估方法，无法系统地比较不同图查询语言和领域模型的能力。

Method: Text2GQL-Bench使用多层次的问答对构建框架以及含有不同资源的ISO-GQL生成，定义了多方面的评估指标。

Result: Text2GQL-Bench展示了ISO-GQL生成中的方言差异：即使强大的LLM在零样本设置下的执行准确率仅为4%，而固定3-shot提示可提高准确率至约50%，尽管语法有效性仍低于70%。微调的8B开放权重模型达到了45.1%的执行准确率和90.8%的语法有效性。

Conclusion: Text2GQL-Bench为Text-to-GQL系统的发展提供了一个全面的基准和评估框架，有助于提高模型的性能。
...
### [57] [AIR: Improving Agent Safety through Incident Response](https://arxiv.org/abs/2602.11749)
...
### [58] [TSR: Trajectory-Search Rollouts for Multi-Turn RL of LLM Agents](https://arxiv.org/abs/2602.11767)
...
### [59] [How to Optimize Multispecies Set Predictions in Presence-Absence Modeling ?](https://arxiv.org/abs/2602.11771)
...
### [60] [RELATE: A Reinforcement Learning-Enhanced LLM Framework for Advertising Text Generation](https://arxiv.org/abs/2602.11780)
...
### [61] [FlowMind: Execute-Summarize for Structured Workflow Generation from LLM Reasoning](https://arxiv.org/abs/2602.11782)
...
### [62] [Beyond End-to-End Video Models: An LLM-Based Multi-Agent System for Educational Video Generation](https://arxiv.org/abs/2602.11790)
...
### [63] [Detecting RLVR Training Data via Structural Convergence of Reasoning](https://arxiv.org/abs/2602.11792)
...
### [64] [Hi-SAM: A Hierarchical Structure-Aware Multi-modal Framework for Large-Scale Recommendation](https://arxiv.org/abs/2602.11799)
...
### [65] [PuYun-LDM: A Latent Diffusion Model for High-Resolution Ensemble Weather Forecasts](https://arxiv.org/abs/2602.11807)
...
### [66] [Predicting LLM Output Length via Entropy-Guided Representations](https://arxiv.org/abs/2602.11812)
...
### [67] [Revis: Sparse Latent Steering to Mitigate Object Hallucination in Large Vision-Language Models](https://arxiv.org/abs/2602.11824)
...
### [68] [Prototype Transformer: Towards Language Model Architectures Interpretable by Design](https://arxiv.org/abs/2602.11852)
...
### [69] [Talk2DM: Enabling Natural Language Querying and Commonsense Reasoning for Vehicle-Road-Cloud Integrated Dynamic Maps with Large Language Models](https://arxiv.org/abs/2602.11860)
...
### [70] [Intelligent AI Delegation](https://arxiv.org/abs/2602.11865)
...
### [71] [From Atoms to Trees: Building a Structured Feature Forest with Hierarchical Sparse Autoencoders](https://arxiv.org/abs/2602.11881)
...
### [72] [When Should LLMs Be Less Specific? Selective Abstraction for Reliable Long-Form Text Generation](https://arxiv.org/abs/2602.11908)
...
### [73] [AlphaPROBE: Alpha Mining via Principled Retrieval and On-graph biased evolution](https://arxiv.org/abs/2602.11917)
...
### [74] [MEME: Modeling the Evolutionary Modes of Financial Markets](https://arxiv.org/abs/2602.11918)
...
### [75] [Gaia2: Benchmarking LLM Agents on Dynamic and Asynchronous Environments](https://arxiv.org/abs/2602.11964)
...
### [76] [CSEval: A Framework for Evaluating Clinical Semantics in Text-to-Image Generation](https://arxiv.org/abs/2602.12004)
...
### [77] [InjectRBP: Steering Large Language Model Reasoning Behavior via Pattern Injection](https://arxiv.org/abs/2602.12013)
...
### [78] [Multi UAVs Preflight Planning in a Shared and Dynamic Airspace](https://arxiv.org/abs/2602.12055)
...
### [79] [LawThinker: A Deep Research Legal Agent in Dynamic Environments](https://arxiv.org/abs/2602.12056)
...
### [80] [Differentiable Modal Logic for Multi-Agent Diagnosis, Orchestration and Communication](https://arxiv.org/abs/2602.12083)
*Antonin Sulc*
...
### [81] [The Pensieve Paradigm: Stateful Language Models Mastering Their Own Context](https://arxiv.org/abs/2602.12108)
...
### [82] [Stop Unnecessary Reflection: Training LRMs for Efficient Reasoning with Adaptive Reflection and Length Coordinated Penalty](https://arxiv.org/abs/2602.12113)
...
### [83] [Commencing-Student Enrolment Forecasting Under Data Sparsity with Time Series Foundation Models](https://arxiv.org/abs/2602.12120)
...
### [84] [HLA: Hadamard Linear Attention](https://arxiv.org/abs/2602.12128)
...
### [85] [Neutral Prompts, Non-Neutral People: Quantifying Gender and Skin-Tone Bias in Gemini Flash 2.5 Image and GPT Image 1.5](https://arxiv.org/abs/2602.12133)
*Roberto Balestri*
...
### [86] [Value Alignment Tax: Measuring Value Trade-offs in LLM Alignment](https://arxiv.org/abs/2602.12134)
...
### [87] [STAR : Bridging Statistical and Agentic Reasoning for Large Model Performance Prediction](https://arxiv.org/abs/2602.12143)
...
### [88] [Seq2Seq2Seq: Lossless Data Compression via Discrete Latent Transformers and Reinforcement Learning](https://arxiv.org/abs/2602.12146)
...
### [89] [GPT-4o Lacks Core Features of Theory of Mind](https://arxiv.org/abs/2602.12150)
...
### [90] [Sci-CoE: Co-evolving Scientific Reasoning LLMs via Geometric Consensus with Sparse Supervision](https://arxiv.org/abs/2602.12164)
...
### [91] [Statistical Parsing for Logical Information Retrieval](https://arxiv.org/abs/2602.12170)
*Greg Coppola*
...
### [92] [Pedagogically-Inspired Data Synthesis for Language Model Knowledge Distillation](https://arxiv.org/abs/2602.12172)
...
### [93] [SAM3-LiteText: An Anatomical Study of the SAM3 Text Encoder for Efficient Vision-Language Segmentation](https://arxiv.org/abs/2602.12173)
...
### [94] ["Sorry, I Didn't Catch That": How Speech Models Miss What Matters Most](https://arxiv.org/abs/2602.12249)
...
### [95] [Think like a Scientist: Physics-guided LLM Agent for Equation Discovery](https://arxiv.org/abs/2602.12259)
...
### [96] [CM2: Reinforcement Learning with Checklist Rewards for Multi-Turn and Multi-Step Agentic Tool Use](https://arxiv.org/abs/2602.12268)
...
### [97] [Agentic Test-Time Scaling for WebAgents](https://arxiv.org/abs/2602.12276)
